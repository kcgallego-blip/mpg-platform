...
export default function SupportCsvUpload({ category, onCancel, onImported }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-slate-950/35 p-4 backdrop-blur-sm"><div className="max-h-[90vh] w-full max-w-3xl overflow-auto rounded-2xl border border-outline-variant bg-surface p-6 shadow-2xl">
